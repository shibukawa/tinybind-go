...
runtime_entries:
  ...
  method_form: since 2026-09-02 each On twin is a method on Handle, h.Load[T](ctx, table, key), and the On function is gone, per decision:generic-method-migration
