...
parameter_interaction:
  patch: api:client-component-update on a live boundary applies the rule:client-mutable-component-parameters patch and restarts the subscription with the new inputs
