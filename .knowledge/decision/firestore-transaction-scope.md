...
typed_transaction:
  ...
  since_go_1_27: the reads are methods on Tx, tx.Load[T](ctx, key) beside tx.Store(v), per decision:generic-method-migration; the suffixed functions are gone, and a declared query's <Name>Tx twin calls the methods
